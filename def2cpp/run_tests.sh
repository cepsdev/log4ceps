...
time ../generator/x86_linux64bit/tst2db  \
...
--output_directory../output --print-no-header-in-sql --dont_increment_sequencer


diff --recursive ../output ../regression
RETVAL=$?
[ $RETVAL -eq 0 ] && echo PASSED
