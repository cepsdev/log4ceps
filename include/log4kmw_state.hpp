...
#ifndef INC_LOG4KMW_STATE_HPP
#define INC_LOG4KMW_STATE_HPP
	...
	class State < >
	{
		public:
			...
			size_t serialize(char *,
				size_t,
				bool,
				log4kmw::throw_exception_policy ) const
			{
				return 0;
			}
			...
			size_t serialize(char,
				size_t,
				bool,
				log4kmw::nothrow_exception_policy) const
			{
				return 0;
			}
	...
	class State<Head,Tail...> : private State < Tail... >
	{
		...
		public:
			...
			size_t serialize(char * buffer, 
							 ...
							 log4kmw::throw_exception_policy) const
			{
				auto t = serialize_value(first(), buffer, size, write_data, log4kmw::throw_exception_policy());
				return t + State<Tail...>::serialize(buffer + t, size - t, write_data, log4kmw::throw_exception_policy());
			}
			...
			size_t serialize(char * buffer, 
							 ...
							 log4kmw::nothrow_exception_policy) const
			{
				auto t = serialize_value(head_, buffer, size, write_data, log4kmw::nothrow_exception_policy());
				if (t == 0) return 0;
				return t + State<Tail...>::serialize(buffer + t, size - t, write_data, log4kmw::throw_exception_policy());
			}
