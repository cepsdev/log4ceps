...
size_t log4ceps::serialize_value(const std::string & v, 
                                 char * buffer, 
...
size_t log4ceps::deserialize_value(std::string & v, 
                                   char * buffer, 
								   size_t max_buffer_size)
{
...
size_t log4ceps::serialize_value(const log4ceps::Dynamic_bitset & v,
						         char * buffer,
						         size_t max_buffer_size,
						         bool write_data,
						         nothrow_exception_policy)
...
size_t log4ceps::deserialize_value(log4ceps::Dynamic_bitset & v, char * buffer, size_t max_buffer_size)
	{
		...
		buffer += sizeof(size_t);
		v = log4ceps::Dynamic_bitset(bits,buffer);
